...
class LocalViewer(Mini3DViewer):
    ...
    def define_gui(self):
        ...
        # window: recording ==================================================================================================
        with dpg.window(
            label="Record", tag="_record_window", autosize=True, pos=(0, self.H // 2)
        ):
            ...
            with dpg.group(horizontal=True):
                ...
                def callback_set_current_keyframe(sender, app_data):
                    ...
                    record_timestep = sum(
                        [keyframe["interval"] for keyframe in self.keyframes[:idx]]
                    )
                ...
                with dpg.group():
                    ...
                    def callback_add_keyframe(sender, app_data):
                        ...
                        dpg.configure_item(
                            "_listbox_keyframes", items=list(range(len(self.keyframes)))
                        )
                    ...
                    dpg.add_button(
                        label="add",
                        tag="_button_add_keyframe",
                        callback=callback_add_keyframe,
                    )
                    ...
                    dpg.add_button(
                        label="delete",
                        tag="_button_delete_keyframe",
                        callback=callback_delete_keyframe,
                    )
                    ...
                    dpg.add_button(
                        label="update",
                        tag="_button_update_keyframe",
                        callback=callback_update_keyframe,
                    )
            ...
            with dpg.group(horizontal=True):
                ...
                dpg.add_input_int(
                    label="interval",
                    tag="_input_interval",
                    default_value=self.cfg.keyframe_interval,
                    width=70,
                    callback=callback_set_keyframe_interval,
                )
            ...
            dpg.add_slider_int(
                label="timeline",
                tag="_slider_record_timestep",
                width=200,
                min_value=0,
                max_value=0,
                format="%d",
                default_value=0,
                callback=callback_set_record_timestep,
            )
            ...
            with dpg.group(horizontal=True):
                ...
                dpg.add_checkbox(
                    label="loop", default_value=True, tag="_checkbox_loop_record"
                )
